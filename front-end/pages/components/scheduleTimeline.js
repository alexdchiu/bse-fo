...
const TimelineEntry = ({game, teamDict}) => {
  ...
  return (
    <li className="mb-10 ml-6">
      ...
      <p className="text-base text-sm font-normal text-gray-500 dark:text-gray-400 indent-3">
    ...
    <div className="container">
      <ol className="relative border-l border-gray-200 dark:border-gray-700">                  
        {/* <li className="mb-10 ml-6">            
            ...
            <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Flowbite Application UI v2.0.0 <span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ml-3">Upcoming Games</span></h3>

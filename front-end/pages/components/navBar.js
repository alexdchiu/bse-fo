      ...
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <a href="https://www.bseglobal.net/" class="flex ml-2 md:mr-24">
              <img src="https://brooklynse.net/bkn/history/assets/logos/logo-2012.png" class="h-8 mr-3" alt="Nets Logo" />
              <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">BSE Global</span>
            </a>
          </div>

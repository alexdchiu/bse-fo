      ...
      <ul className="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
         ...
         <li>
            {/* <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
               ...
               <button className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700" onClick={handleOpen}><span>Other Teams</span></button>
                {open ? (
              // <ul>
